...
return(
    ...
    <button className="btn btn-outline-danger d-block mb-2" onClick="">update profile</button>
 <button className="btn btn-outline-info" onClick="">change your password</button>
    </div>
);
}
